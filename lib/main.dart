  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        // Optional: you can define a global font or styling here
      ),
      debugShowCheckedModeBanner: false, // Hides the debug banner in the top right

      // This is where you tell the app to load the LoginScreen first
      home: const LoginScreen(),

      // Define the starting point of your app
      initialRoute: '/login',

      // Map string paths to your actual screen widgets
      routes: {
